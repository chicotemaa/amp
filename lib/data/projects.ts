...
export const PROJECTS: Project[] = [
    ...
    {
        id: 7,
        name: "Parque Logístico Andino",
        location: "Corredor Industrial Oeste",
        type: "industrial",
        status: "planning",
        progress: 15,
        ...
        clientId: 4,
        onTrack: true,
        description: "Centro logístico con naves modulares, playa de maniobras y sector de frío industrial.",
    },
    {
        id: 8,
        name: "Conjunto Habitacional Los Tilos",
        ...
        clientId: 1,
        onTrack: false,
        description: "Barrio de 24 viviendas con urbanización interna, espacios verdes y salón comunitario.",
    },
];
